# Requirements Archive: v1.6 Touch UX & Data Traceability
...
- [x] **MLDB-05**: yeni_kesme_hizi, yeni_inme_hizi, katsayi fields contain actual values (not None) — fixed 2026-02-04 (new records only; historical records retain NULL)
