...
<!-- v1.6 Touch UX & Data Traceability -->

- [ ] Dokunmatik ekran long press fix — konumlandırma butonlarında touch event handling
- [ ] ML DB None değerler araştırma ve düzeltme — yeni hız/katsayı alanları
- [ ] ML DB kesim_id, makine_id, serit_id, malzeme_cinsi eklenmesi
- [ ] Anomaly DB makine_id, serit_id, malzeme_cinsi eklenmesi
...
## Current Milestone: v1.6 Touch UX & Data Traceability

**Goal:** Dokunmatik ekran kullanılabilirliği ve veritabanı veri izlenebilirliği

**Target features:**
- Touch long press fix for positioning buttons
- ML DB None values investigation and fix
- ML/Anomaly DB traceability fields (kesim_id, makine_id, serit_id, malzeme_cinsi)

---
*Last updated: 2026-01-29 after v1.6 milestone start*
