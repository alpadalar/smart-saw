...
class TitresimXDetector(BaseAnomalyDetector):
    """Vibration X anomaly detector - Uses IQR method (robust to outliers)"""
    ...
    def __init__(self, buffer_size: int = 100, min_samples: int = 10):
        ...
        logger.info("TitresimXDetector initialized (IQR method)")


class TitresimYDetector(BaseAnomalyDetector):
    """Vibration Y anomaly detector - Uses IQR method (robust to outliers)"""
    ...
    def __init__(self, buffer_size: int = 100, min_samples: int = 10):
        ...
        logger.info("TitresimYDetector initialized (IQR method)")


class TitresimZDetector(BaseAnomalyDetector):
    """Vibration Z anomaly detector - Uses IQR method (robust to outliers)"""
    ...
    def __init__(self, buffer_size: int = 100, min_samples: int = 10):
        ...
        logger.info("TitresimZDetector initialized (IQR method)")
